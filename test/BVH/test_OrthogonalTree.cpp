...
TEST_F(test_OrthogonalTree, ConstructQuadTree)
{
  ...
  std::cout << std::format("QuadTree node size {}, vertex size {}\n",
                           sizeof(QuadTree::Node), sizeof(QuadTree::Vertex));
...
TEST_F(test_OrthogonalTree, ConstructOcTree)
{
  ...
  std::cout << std::format("OcTree node size {}, vertex size {}\n",
                           sizeof(OcTree::Node), sizeof(OcTree::Vertex));
