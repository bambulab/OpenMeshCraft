...
Rem FOR %%f in (.\lambda\*.txt) DO ..\..\..\build\bin\Release\IndirectPredicatesGenerator.exe %%f -a -ft -it -et -ex
FOR %%f in (.\indirect\*.txt) DO ..\..\..\build\bin\Release\IndirectPredicatesGenerator.exe %%f -a -it -et -ex
